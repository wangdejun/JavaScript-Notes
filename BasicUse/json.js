...
/*布尔值，数字，字符串的包装对象会在序列化的过程中自动转化为相应的原始值 wrapped value*/
/*undefined,任意的函数（其实这个函数会发生神奇的事，以及symbol的值）
	1.出现在非数组对象的属性值中：在序列化中会被忽略，
	2.出现在数组中，会被转化为null
*/

console.log(JSON.stringify({x:"wang",y:undefined,z:"undefined",w:[undefined,undefined]}))
...
console.log(JSON.stringify({x:"abc",y:NaN,z:Infinity,w:-Infinity}))
